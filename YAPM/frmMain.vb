                ...
                If Len(s) > 0 Then
                    ...
                    If s.Substring(s.Length - 3, 3).ToLower = "txt" Then
                        ...
                        For Each it In Me.lvModules.Items
                            ...
                            stream.Write(c)
                        Next
                        c = CStr(Me.lvModules.Items.Count) & " modules(s)"
                        stream.Write(c)
                        stream.Close()
                    Else
                        ' HTML
                        Dim title As String = CStr(Me.lvModules.Items.Count) & " modules(s)"
                ...
                If Len(s) > 0 Then
                    ...
                    If s.Substring(s.Length - 3, 3).ToLower = "txt" Then
                        ...
                        For Each it In Me.lvThreads.Items
                            ...
                            stream.Write(c)
                        Next
                        c = CStr(Me.lvThreads.Items.Count) & " thread(s)"
                        stream.Write(c)
                        stream.Close()
                    Else
                        ' HTML
                        Dim title As String = CStr(Me.lvThreads.Items.Count) & " thread(s)"
                        Dim _html As New cHTML2(s, title, 25)
                ...
                If Len(s) > 0 Then
                    ...
                    If s.Substring(s.Length - 3, 3).ToLower = "txt" Then
                        ...
                        For Each it In Me.lvWindows.Items
                            ...
                            stream.Write(c)
                        Next
                        c = CStr(Me.lvWindows.Items.Count) & " windows(s)"
                        stream.Write(c)
                        stream.Close()
                    Else
                        ' HTML
                        Dim title As String = CStr(Me.lvWindows.Items.Count) & " windows(s)"
                        Dim _html As New cHTML2(s, title, 25)
                ...
                If Len(s) > 0 Then
                    ...
                    If s.Substring(s.Length - 3, 3).ToLower = "txt" Then
                        ...
                        For Each it In Me.lvServices.Items
                            ...
                            stream.Write(c)
                        Next
                        c = CStr(Me.lvServices.Items.Count) & " service(s)"
                        stream.Write(c)
                        stream.Close()
                    Else
                        ' HTML
                        Dim title As String = CStr(Me.lvServices.Items.Count) & " service(s)"
                        Dim _html As New cHTML2(s, title, 25)
