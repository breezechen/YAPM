...
Public Class frmPreferences
    ...
    Private Sub frmPreferences_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With frmMain
            ...
            .SetToolTip(Me.txtProcessIntervall, "Set intervall (milliseconds) between two refreshment of processes list")
            .SetToolTip(Me.txtServiceIntervall, "Set intervall (milliseconds) between two refreshment of services list")
