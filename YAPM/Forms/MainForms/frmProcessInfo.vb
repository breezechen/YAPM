...
Public Class frmProcessInfo
    ...
    Private Sub frmProcessInfo_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        Me.lvHandles.Dispose()
        Me.lvHeaps.Dispose()
        Me.lvLog.Dispose()
        Me.lvModules.Dispose()
        Me.lvPrivileges.Dispose()
        Me.lvProcEnv.Dispose()
        Me.lvProcMem.Dispose()
        Me.lvProcNetwork.Dispose()
        Me.lvProcServices.Dispose()
        Me.lvProcString.Clear()
        Me.lvThreads.Dispose()
        Me.lvWindows.Dispose()
        ReDim __lRes(0)
        ReDim __sRes(0)
