...
Public Class frmAboutG
    ...
    Private Sub frmAboutG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim it4 As New ListViewItem("dll")
            it4.SubItems.Add(System.Diagnostics.FileVersionInfo.GetVersionInfo(My.Application.Info.DirectoryPath & "\dll").FileVersion)
            Dim it5 As New ListViewItem("dll")
            it5.SubItems.Add(System.Diagnostics.FileVersionInfo.GetVersionInfo(My.Application.Info.DirectoryPath & "\dll").FileVersion)
