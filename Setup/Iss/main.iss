...
AppContact=maito:yetanotherprocessmonitor@gmail.com
AppName={#MyAppName}
...
OutputBaseFilename=YAPM-v{#MyAppVersion}-Setup
...
VersionInfoDescription=Yet Another (remote) Process Monitor Setup
...
[CustomMessages]
noDotNetInstalled =YAPM {#MyAppVersion} requires Microsoft .Net Framework 2.0 to work. Please install .Net Framework 2.0 and then try to install YAPM again. Would you like to download .Net Framework 2.0 now ?
