...
Public Class cRemoteServiceWMI
    Inherits cService
...
#Region "API"
    ...
    ' Enums
    ' ========================================
    Private Enum ServiceTypeR As Integer
        Adapter = 4
        FileSystemDriver = 2
...
#Region "Getter & setter"
    ...
    Public Overrides ReadOnly Property HasChanged(ByVal _serv As LightService) As Boolean
        Get
            ' State & start & process
    ...
    Public Overrides ReadOnly Property Name() As String
        ...
        End Get
    End Property
    Public Overrides ReadOnly Property LongName() As String
        Get
            Return _LongName
        End Get
    End Property
    Public Overrides ReadOnly Property Type() As String
        Get
            Select Case _dwServiceType
                Case ServiceTypeR.Adapter
                    Return "Adapter"
                Case ServiceTypeR.FileSystemDriver
                    Return "FileSystemDriver"
                Case ServiceTypeR.InteractiveProcess
                    Return "InteractiveProcess"
                Case ServiceTypeR.KernelDriver
                    Return "KernelDriver"
                Case ServiceTypeR.RecognizerDriver
                    Return "RecognizerDriver"
                Case ServiceTypeR.Win32OwnProcess
                    Return "Win32OwnProcess"
                Case ServiceTypeR.Win32ShareProcess
        ...
        End Get
    End Property
    Public Overrides ReadOnly Property ImagePath() As String
        Get
            Return _imagePath
        End Get
    End Property
    Public Overrides ReadOnly Property ErrorControl() As Integer
        Get
    ...
    Public Overrides ReadOnly Property ProcessID() As Integer
        ...
        End Get
    End Property
    Public Overrides ReadOnly Property ProcessName() As String
        Get
            Return _processName
        End Get
    End Property
    Public Overrides ReadOnly Property LoadOrderGroup() As String
        Get
            Return _lpLoadOrderGroup
        End Get
    End Property
    Public Overrides ReadOnly Property ServiceStartName() As String
        Get
            Return _lpServiceStartName
        End Get
    End Property
    Public Overrides ReadOnly Property AcceptedControls() As ACCEPTED_CONTROLS
        Get
            Return _dwControlsAccepted
        End Get
    End Property
    Public Overrides ReadOnly Property State() As SERVIVE_STATE
        Get
            Return _dwCurrentState
        End Get
    End Property

    Public Overrides ReadOnly Property ServiceStartTypeInt() As TypeServiceStartType
        Get
    ...
    Public Overrides ReadOnly Property ServiceStartType() As String
        Get
    ...
    Public Overrides ReadOnly Property Description() As String
        ...
        End Get
    End Property
    Public Overrides ReadOnly Property DiagnosticsMessageFile() As String
        Get
            If Not (gotDiag) Then
                gotDiag = True
...
#End Region
    ...
    ' Resume a service
    Public Overrides Sub ResumeService()
        Dim lpSS As SERVICE_STATUS
    ...
    ' Shutdown a service
    Public Overrides Sub ShutDownService()
        Dim lpSS As SERVICE_STATUS
    ...
    Public Overrides Sub SetServiceStartType(ByVal type As TypeServiceStartType)
    ...
    ' Stop a service
    Public Shared Shadows Sub StopTheService(ByVal serviceName As String)
