...
Public Class cHandle
    ...
    Private Shared handles_Renamed As New clsOpenedHandles
    ...
    Public Shared Function Enumerate(ByVal processId As Integer(), ByVal showUNN As _
        ...
        Try
            Call handles_Renamed.Refresh(processId)

            ReDim key(handles_Renamed.Count)      ' Temporary size
            Dim x As Integer = 0
            For i As Integer = 0 To handles_Renamed.Count - 1
                If handles_Renamed.GetHandle(i) > 0 Then
                    If showUNN OrElse (Len(handles_Renamed.GetObjectName(i)) > 0) Then
