...
#End Region
    ...
    Public Overrides Function GetEnvironmentVariables(ByRef variables() As String, _
    ...
    Public Function GetInformationAsStateThreshold(ByVal infoName As String) As  _
        ...
        Select Case infoName
            ...
            Case "HandleCount"
                _threshold = New StateThreshold(ThresoldType.INTEGER, Me.HandleCount)
        End Select
    ...
    Private Function recursiveKill(ByVal pid As Integer) As Integer
        ...
        ' Get all items...
        Dim _dicoFull As New Dictionary(Of String, cProcess.LightProcess)
        Dim _dico2 As New Dictionary(Of String, cProcess.LightProcess)
        Enumerate(_dicoFull)

        ' ... and extract only childs
        For Each t As cProcess.LightProcess In _dicoFull.Values
        ...
        ' Recursive kill
        For Each t As cProcess.LightProcess In _dico2.Values
            recursiveKill(t.pid)
        Next
